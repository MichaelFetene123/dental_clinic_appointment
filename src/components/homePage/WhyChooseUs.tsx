                ...
                >
                    ...
                    <div className='mt-8 space-y-6'>
                        <div className='flex items-center'>
                            ...
                            <p className='font-inter text-base md:text-lg font-normal text-gray-700'>Expert & Caring Team</p>
                        </div>
                        <div className='flex items-center'>
                            <FaCheckCircle className='text-primary text-2xl mr-3' />
                            <p className='font-inter text-base md:text-lg font-normal text-gray-700'>State-of-the-Art Equipment</p>
                        </div>
                        <div className='flex items-center'>
                            <FaCheckCircle className='text-primary text-2xl mr-3' />
                            <p className='font-inter text-base md:text-lg font-normal text-gray-700'>Comprehensive Treatment Options</p>
                        </div>
                        <div className='flex items-center'>
                            <FaCheckCircle className='text-primary text-2xl mr-3' />
                            <p className='font-inter text-base md:text-lg font-normal text-gray-700'>Affordable Care Plans</p>
                        </div>
                    </div>
