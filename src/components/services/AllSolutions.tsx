  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto py-32 px-4 items-center md:justify-between">
      <div className="flex-1 justify-between ">
        <h2 className="text-5xl font-heading mb-10 text-foreground">All-in-one Dental Solutions for the Whole Family</h2>
        <div className='flex flex-col text-lg text-muted-foreground'>
          ...
          <p className="text-justify">
            <Link href={'/appointment'} className=' font-bold hover:text-primary transition-colors duration-200'>Book Now</Link>{" "}
